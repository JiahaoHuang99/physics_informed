...
# set name of job
#SBATCH --job-name=FNO-IncomNS2D-PDEBench-Dx8-Tx50
...
# output log
#SBATCH -o /home/jh2446/physics_graph_transformer/physics_informed/server/HPC-CAM/log/FNO-IncomNS2D-PDEBench-Dx8-Tx50.o

# error log
#SBATCH -e /home/jh2446/physics_graph_transformer/physics_informed/server/HPC-CAM/log/FNO-IncomNS2D-PDEBench-Dx8-Tx50.e
